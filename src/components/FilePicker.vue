    ...
    onFileInputChange(event) {
      if (event.target.files && event.target.files.length) {
        ...
        if (!window.FileReader) {
          console.log(`Votre navigateur ne supporte pas l'importation de fichiers !`)
          return
        ...
        console.log('Format de fichier incorrect. Vous devez séléctionner un fichier .ics encodé utf-8 ou un fichier pdf.')
      }
    }
	}
})
